        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-6">
                    <div class="white-box text-center" style="width: 100%;height: 100%;"><img src="image/<?php echo $movie_data['movie_image'];  ?>" class="img-responsive" style="width: 70%; height: 90%;"></div>
                </div>
                <div class="col-lg-7 col-md-7 col-sm-6">
                    ...
                    <div class="form-floating">
                      <select name="time">
                        ...
                        <option value="20:00">19:0</option>
                        <option value="22:00">19:0</option>
                      </select>
                    </div>
